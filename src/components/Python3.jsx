    ...
    return(
        <div>
            ...
            <div className="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 overflow-hidden text-block">
                ...
                <h2 className="display-5 titolo">Aprenda o básico de python aqui</h2>
                ...
                <hr className="bg-white" />
                    <p>#Aqui é um comentário! Abaixo estamos declarando uma variável x e atribuindo o valor de Olá, mundo a ela, depois mostrando na tela com o comando print(x).</p>
